...
public class BiomeJujuForest : ModItem
{
	...
	public static bool OnBreak(Item item, Entity pred, bool direct)
	{
		...
		if (playerPred != null)
		{
			...
			{
				playerPred.AsPred().PermanentUpgradesGained.Add("BiomeJujuForest", value: false);
			}
	...
	{
		_ = Main.LocalPlayer;
		tooltips.AddVorariaDynamicItemTooltip("Voraria.Consumables.PermanentUpgrades.Jujus.BiomeJujuForest", new
		{
			TUM = TUMBonus,
			ABS = ABSBonus,
	...
	{
		((ModItem)this).CreateRecipe(1).AddIngredient<BlankJuju>(1).AddIngredient(9, 25)
			.AddIngredient(63, 3)
			.AddIngredient(5, 5)
			.AddIngredient(23, 100)
			.Register();
	}
}
