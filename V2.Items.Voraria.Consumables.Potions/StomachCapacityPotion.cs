...
public class StomachCapacityPotion : ModItem
{
	...
	public static int DigestedCapacityBoostTime => V2Utils.SensibleTime(0, 3);
	...
	public override void SetDefaults()
	{
		...
		((ModItem)this).Item.buffType = ModContent.BuffType<StomachCapacityPotionBuff>();
		((ModItem)this).Item.buffTime = DigestedCapacityBoostTime;
	...
	public static void UpdateInStomach(Entity prey, Entity pred, bool dead)
	{
		if (dead)
		{
			pred.AddStatus(ModContent.BuffType<StomachCapacityPotionBuff>(), DigestedCapacityBoostTime, fromDigestingSomething: true);
		}
	}
	...
	{
		tooltips.AddVorariaDynamicItemTooltip("Voraria.Consumables.Potions.StomachCapacityPotion", new
		{
