...
public class ThrowableHotSauceBottle : ModItem
{
	...
	public override void SetDefaults()
	{
		...
		item.UseSound = item2;
		((ModItem)this).Item.shoot = ModContent.ProjectileType<ThrowableHotSauceBottleProjectile>();
	...
	{
		tooltips.AddVorariaDynamicItemTooltip("Voraria.Weapons.Ranged.Throwables.FragileBottles.HotSauce", new
		{
