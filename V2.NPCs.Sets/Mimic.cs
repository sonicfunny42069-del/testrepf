...
public class Mimic : GlobalNPC
{
	...
	{
		return V2Utils.NPCIDSets.Mimics.Contains(entity.type);
	}
	...
	public override void SetDefaults(NPC npc)
	{
		...
		preyNPC.OnDigestedBy = (PreyNPC.DelegateOnKilledByDigestion)Delegate.Combine(preyNPC.OnDigestedBy, new PreyNPC.DelegateOnKilledByDigestion(OnDigestedBy_GrantMimicGoal));
	}
