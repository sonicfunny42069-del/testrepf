...
public class TheGroom : GlobalNPC
{
	...
	public override void PostAI(NPC npc)
	{
		...
		num2++;
		span[num2] = (TargetType.Projectile, 895, TargetPriorityLevel.Neutral);
		num2++;
	...
	public static bool CanTheGroomBeForceFed(NPC npc)
	{
		return true;
	}
	...
	public static void GetDigestedPlayerAdditionalDeathMessages(NPC npc, Player player, List<string> deathReasonKeyList)
	{
		...
		deathReasonKeyList.AddRange(new List<string> { "Mods.V2.Death.DigestedPlayer.SpecificNPC.Forest.Zombie.1", "Mods.V2.Death.DigestedPlayer.SpecificNPC.Forest.Zombie.2", "Mods.V2.Death.DigestedPlayer.SpecificNPC.Forest.Zombie.3", "Mods.V2.Death.DigestedPlayer.SpecificNPC.BloodMoon.GroomAndBride.1", "Mods.V2.Death.DigestedPlayer.SpecificNPC.BloodMoon.GroomAndBride.2", "Mods.V2.Death.DigestedPlayer.SpecificNPC.BloodMoon.GroomAndBride.TheGroom.1" });
	...
	public override void ModifyHoverBoundingBox(NPC npc, ref Rectangle boundingBox)
	{
		...
		boundingBox = new Rectangle((int)((Entity)npc).Center.X - 17, (int)((Entity)npc).Center.Y - 26, 34, 52);
	}
	...
	public static void OnKilledByDigestion_GrantBrideAndGroomGoal(NPC npc, Entity pred)
	{
		...
		if (predPlayer != null && predPlayer.AsPred().mealCount.ContainsKey("Terraria: The Bride") && predPlayer.AsPred().mealCount["Terraria: The Bride"] > 0)
		{
	...
	public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
	{
		...
		TextureAssets.Npc[53] = ModContent.Request<Texture2D>(exactMainBodyTexture, (AssetRequestMode)1);
		return true;
	}
}
