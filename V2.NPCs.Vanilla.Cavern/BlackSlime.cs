...
public class BlackSlime : GlobalNPC
{
	public override bool InstancePerEntity => true;

	public static void V2BlackSlimeFirstFrameAI(NPC npc)
	{
		GeneralizedAIOverrides.SimpleSlimeFirstFrameAI(npc, 18);
	}

	public static bool V2BlackSlimeAI(NPC npc)
	{
		return GeneralizedAIOverrides.SimpleSlimeAI(npc, 1.05f, 25, 18);
	}
	...
	public override void SetDefaultsFromNetId(NPC npc)
	{
		...
		if (npc.netID == -6)
		{
			...
			slimeNPC.HighJumpXModifier += 0.333f;
			SlimeNPC slimeNPC2 = npc.AsSlime();
			slimeNPC2.HighJumpYModifier += 0.333f;
	...
	public static bool CanBlackSlimeBeForceFed(NPC npc)
	{
		return true;
	}
