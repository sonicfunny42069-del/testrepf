...
public class JungleSlime : GlobalNPC
{
	public override bool InstancePerEntity => true;

	public static void V2JungleSlimeFirstFrameAI(NPC npc)
	{
		GeneralizedAIOverrides.SimpleSlimeFirstFrameAI(npc, 19);
	}

	public static bool V2JungleSlimeAI(NPC npc)
	{
		return GeneralizedAIOverrides.SimpleSlimeAI(npc, 1.05f, 26, 19);
	}
	...
	public override void SetDefaultsFromNetId(NPC npc)
	{
		...
		if (npc.netID == -10)
		{
			...
			npc.AsSlime().JumpDelayExtra = (Min: V2Utils.SensibleTime(0, 0, 0, 20), Max: V2Utils.SensibleTime(0, 0, 0, 30));
			...
			slimeNPC2.HighJumpYModifier += 0.5f;
	...
	public static bool CanJungleSlimeBeForceFed(NPC npc)
	{
		return true;
	}
	...
	{
		return 15.0 * (npc.AsFood().DefinedEffectiveSize / npc.AsFood().DefinedBaseSize);
	}
