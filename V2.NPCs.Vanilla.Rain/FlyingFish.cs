...
public class FlyingFish : GlobalNPC
{
	...
	public override void SetDefaults(NPC npc)
	{
		...
		preyNPC.OnDigestedBy = (PreyNPC.DelegateOnKilledByDigestion)Delegate.Combine(preyNPC.OnDigestedBy, new PreyNPC.DelegateOnKilledByDigestion(OnKilledByDigestion_GrantFlyingFishGoal));
	}
