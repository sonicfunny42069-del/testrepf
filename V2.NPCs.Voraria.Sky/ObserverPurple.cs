...
public class ObserverPurple : ModNPC
{
	public override void SetStaticDefaults()
	{
		...
		val.CustomTexturePath = "V2/NPCs/Voraria/Sky/ObserverPurple";
	...
	public override void SetDefaults()
	{
		...
		preyNPC.OnDigestedBy = (PreyNPC.DelegateOnKilledByDigestion)Delegate.Combine(preyNPC.OnDigestedBy, new PreyNPC.DelegateOnKilledByDigestion(ObserverRed.OnDigestedBy_GrantObserverGoal));
	}
	...
	public override void AI()
	{
		...
		if (((ModNPC)this).NPC.HasValidTarget)
		{
			...
			if (target != null)
			{
				...
				((Entity)nPC).velocity = ((Entity)nPC).velocity + direction / 60f;
			}
		}
	...
	public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
	{
		...
		((Rectangle)(ref sourceRect))._002Ector(200, ((ModNPC)this).NPC.frame.Y, 100, 114);
		...
		((Rectangle)(ref sourceRect2))._002Ector(40, 0, 20, 20);
	...
	public override void HitEffect(HitInfo hit)
	{
		...
		if (Main.netMode != 2 && ((ModNPC)this).NPC.life <= 0)
		{
			...
			int Gore2 = ((ModType)this).Mod.Find<ModGore>("Gore_ObserverPurple").Type;
			for (int i = 0; i < 10; i++)
			{
