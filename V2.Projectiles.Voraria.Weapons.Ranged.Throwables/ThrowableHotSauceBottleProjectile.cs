...
public class ThrowableHotSauceBottleProjectile : ModProjectile
{
	...
	{
		target.AddBuff(ModContent.BuffType<TastySpicy>(), V2Utils.SensibleTime(0, 0, 20), false);
	}
	...
	public override void OnKill(int timeLeft)
	{
		...
		{
			Dust.NewDustPerfect(((Entity)(object)((ModProjectile)this).Projectile).TrueCenter(), Utils.NextBool(Main.rand) ? 35 : 6, (Vector2?)Utils.RotatedByRandom(Utils.RotatedBy(new Vector2(0f, 4f), (double)(degreesPerCondimentDust * (float)i), default(Vector2)), (double)(degreesPerCondimentDust / 5f)), 0, default(Color), 1.25f);
		}
