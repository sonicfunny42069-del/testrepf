...
public class DoNotEatTheVileMushroom_ProjectileEntity : ModProjectile
{
	...
	public override void AI()
	{
		...
		{
			((ModProjectile)this).Projectile.ai[0] = Main.rand.Next(350, 650);
		}
		((ModProjectile)this).Projectile.timeLeft = 6000;
		...
		if (!((Tile)(ref Painting)).HasTile || ((Tile)(ref Painting)).TileType != ModContent.TileType<DoNotEatTheVileMushroom>())
		{
