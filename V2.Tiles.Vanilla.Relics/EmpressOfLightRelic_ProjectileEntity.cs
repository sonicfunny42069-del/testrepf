...
public class EmpressOfLightRelic_ProjectileEntity : ModProjectile
{
	...
	public override void SetDefaults()
	{
		...
		((Entity)((ModProjectile)this).Projectile).width = 48;
	...
	public override void AI()
	{
		...
		if (!((Tile)(ref Painting)).HasTile || ((Tile)(ref Painting)).TileType != ModContent.TileType<EmpressOfLightRelic>())
		{
	...
	{
		return Math.Min((int)Math.Floor(6.0 * Math.Sqrt(PredProjectile.GetCurrentBellyWeight(projectile))), 5);
	}
